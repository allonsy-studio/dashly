...
<h1 align="center" border="none">dashly</h1>

<p align="center">
  <img src="https://github.com/allonsy-studio/.github/blob/main/assets/tag-rule.gif" alt="" height="30" />
</p>

<p align="center"><b>A standard-library of filters, transforms, and shortcodes for 11ty. One install, one plugin line, done.</b></p>

<p align="center">
  <a href="https://www.npmjs.com/package/@allons-y/dashly">
    <img src="https://img.shields.io/npm/v/@allons-y/dashly.svg" alt="NPM version" height="20" />
  </a>
  <a href="https://www.npmjs.com/package/@allons-y/dashly">
    <img src="https://img.shields.io/npm/dw/@allons-y/dashly.svg" alt="NPM downloads" height="20" />
  </a>
  <a href="https://github.com/allonsy-studio/dashly/actions/workflows/testing.yml">
    <img src="https://github.com/allonsy-studio/dashly/actions/workflows/testing.yml/badge.svg?branch=main" alt="Tests" height="20" />
  </a>
  <a href="https://github.com/allonsy-studio/dashly/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/allonsy-studio/dashly.svg" alt="License" height="20" />
  </a>
  <a href="https://allons-y.studio">
...
Contributions are welcome and appreciated! Please open an [issue](https://github.com/allonsy-studio/dashly/issues/new) (before submitting a pull request) if you find a bug, have a feature request, or have a question. Be sure to follow the [contribution guidelines](.github/CONTRIBUTING.md) and [code of conduct](.github/CODE_OF_CONDUCT.md) but most importantly, be excellent to each other. 💖
